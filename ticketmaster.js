...
const displayEvents = function (e) {
    ...
    $.ajax({
        ...
        try {
            ...
            $('#eventFlight').on('click', findAirport);
...
// $('#eventFlight').on('click',getFlightInfo(iataSrc,'LAX','20181017', '20181030'))
